...
{
  "bsGitBranch" : "main",
  "bsGitRepository" : "github.com?owner=benwilcock&repo=tanzu-java-web-app",
  "projectName" : "tanzu-java-web-app",
  "repositoryPrefix" : "eu.gcr.io/tap-shared-instance/image-sources/tanzu-java-web-app-source"
}
```
## Log
```
...
┃ ┃ ┃ ┃ ┗ ┗  Info Will replace [your-registry.io/project->eu.gcr.io/tap-shared...(truncated)]
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug Adding symbol repoUrl with value 'https://github.com?owner=benwilcock&repo=tanzu-java-web-app'
